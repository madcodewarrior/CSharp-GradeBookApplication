    ...
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if(parts[2] == "standard")
            {
                ...
                GradeBookUserInterface.CommandLoop(new StandardGradeBook(name, bool.Parse(parts[3])));
            }
            else if (parts[2] == "ranked")
            {
                Console.WriteLine("Created gradebook {0}.", name);
                GradeBookUserInterface.CommandLoop(new RankedGradeBook(name, bool.Parse(parts[3])));
            }
            else
            {
